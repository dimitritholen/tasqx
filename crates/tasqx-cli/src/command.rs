...
pub(super) enum Command {
    ...
    Report {
        ...
        /// total — same date grammar as `--due` (D97).
        ///
    ...
    /// `started` says whether this call actually opened a timer: false when you
    /// left, and false on a task that was already running, which `start`
