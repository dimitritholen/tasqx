...
| `list` | `ls`, `l`, *(bare)* | Fuzzy project prefix (`work.t` → `work.tasqx`). **Not yet built:** saved filters (`tasqx ls @overdue`) — `list` refuses any `@` token but `@working`/`@blocked` today (audit-2026-09 #226.2). |
