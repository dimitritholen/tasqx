...
### D182 — `store.import` merges a memory doc onto the destination doc that already holds its `source`, later `modified` wins, and reports every merge (task #782; extends D174, twins D177)
