...
### D160 — the reference gains one page per object; a field is documented on the page of the object it describes, exactly once, and the object pages and method sections link each other from one function (extends D158)
