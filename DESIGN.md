...
### D89 — The HTML report's data sections may break out past the ~72ch prose measure on wide viewports (amends §8's Layout row; tasqx audit #235/3)
...
### D90 — The HTML report footer names its generation instant in local time; D76's "humanizing is deferred" edge gets one narrow, explicit exception (tasqx audit #235/4)
