...
### D103 — A daemon that fell silent says so too, not only one that retired on a timer
...
### D104 — The OTLP receiver refuses a body declared `application/x-protobuf`, and that narrows tolerance rather than breaking it
