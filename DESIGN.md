...
### D89 — The terminal TOKENS cell stays a volume ranking with a legend and an escape hatch; D48(a)'s "weighted dominance ratio" is retired, not merely unbuilt (tasqx audit-2026-09 #212)
...
### D90 — `render::san` strips TAB; `html::esc` keeps it — D19's shared RULE, not a shared exception list (tasqx audit-2026-09 #234 item 10, duplicate of #228)
