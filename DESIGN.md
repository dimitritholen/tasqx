...
### D157 — response shapes are documented in core beside the freeze, and the API/MCP reference is generated from PARAMS, the MCP schemas and those shapes (extends D33, D74, D149)
