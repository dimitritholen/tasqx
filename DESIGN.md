...
### D158 — `tasqx setup` installs the Claude Code integration from what the binary carries: the MCP registration through `claude mcp add --scope user`, and the bundled skills, keeping a skill file that differs unless told to replace it
